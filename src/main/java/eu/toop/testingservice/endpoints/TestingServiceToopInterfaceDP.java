 ...
 */
package eu.toop.testingservice.endpoints;
...
public class TestingServiceToopInterfaceDP implements IToopInterfaceDP {
  private final UI _ui;

  public TestingServiceToopInterfaceDP (final UI ui) {
